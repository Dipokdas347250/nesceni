                    ...
                    <div className="">
                       ...
                       <div className=" lg:flex justify-between gap-5 mt-5">
                        ...
                        <div className=" lg:w-[33%] w-full  p-4 my-3 lg:my-0 bg-[#fff] rounded-md  drop-shadow-lg duration-300 ease-in-out hover:transform hover:scale-105">
                            ...
                            <p className=' text-[#4D4D4D] font-semibold text-[16px] font-inter text-center'>OBuild stronger connections through seamless communication and interaction.</p>
                        </div>
                        <div className=" lg:w-[33%] w-full  p-4 bg-[#fff] rounded-md  drop-shadow-lg duration-300 ease-in-out hover:transform hover:scale-105">
                            ...
                            <p className=' text-[#4D4D4D] font-semibold text-[16px] font-inter text-center'>Make informed decisions with real-time data and actionable insights.</p>
                        </div>
                       </div>
                </Container>
            </section>
