      ...
      <section className="py-10 lg:px-1 px-2 bg-[#fff]" id='product'>
        <Container>
          ...
          <div className="text-center">
            ...
            <p className="text-[#7E7E7E] text-[16px] font-medium font-inter mt-3 lg:w-[615px] m-auto">Building smarter communities through trust, empathy, and technology.

              Human-first technology designed to connect, engage, and grow.

              Where intelligent systems meet genuine care.

              Empowering communities with thoughtful digital solutions.

              Because meaningful connections drive better outcomes.</p>
